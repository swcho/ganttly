/*
 ...
 dhtmlxGantt v.3.0.0 dhtmlx.com
...
var _0xe612 = ["href", "location", "", "indexOf", "", "This version of Gantt is not intended for using outside of dhtmlx.com", "message", "random", "floor"];
!function () {
    var t = document[_0xe612[1]][_0xe612[0]];
    -1 == t[_0xe612[3]](_0xe612[2]) && setTimeout(function () {
        dhtmlx[_0xe612[6]]({type: _0xe612[4], text: _0xe612[5], expire: -1})
    ...
    function h(t, e, n, i) {
        return"object" != typeof t && (t = {text: t, type: e, expire: n, id: i}), t.id = t.id || c.uid(), t.expire = t.expire || c.expire, t
    }
...
}(), gantt = {version: "3.0.0"}, dhtmlxEventable = function (obj) {
    ...
    t = t || window.event;
    var e = t.target || t.srcElement, n = gantt.locate(t), i = !0;
    ...
    t = t || window.event;
    var e = t.target || t.srcElement, n = gantt.locate(t), i = !gantt.checkEvent("onTaskDblClick") || gantt.callEvent("onTaskDblClick", [n, t]);
    if (i) {
    ...
    if (this.config.autofit) {
        var t = this.getGridColumns(), e = 0, n = [], i = [];
    ...
    dhtmlx.defined(this.config.dnd_sensitivity) && (t.config.sensitivity = this.config.dnd_sensitivity), t.attachEvent("onBeforeDragStart", dhtmlx.bind(function (e, n) {
        ...
        var a = this.locate(n), s = gantt.getTask(a);
        ...
        var e = this._get_position(this.$grid_data), n = e.x, i = t.pos.y - 10;
        ...
        var i = t.config, a = t._getGridPos(n);
        i.marker.style.left = a.x + 10 + "px", i.marker.style.top = a.y + "px", a = t._getGridPos(n);
        var s = (a.x, a.y), r = document.elementFromPoint(a.x - document.body.scrollLeft + 1, s - document.body.scrollTop), o = this.locate(r), d = this.getTask(t.config.id);
        if (this.isTaskExists(o) || (o = t.lastTaskOfLevel(d.$level), o == t.config.id && (o = null)), this.isTaskExists(o)) {
            var l = gantt._get_position(r), _ = this.getTask(o);
            if (l.y + r.offsetHeight / 2 < s) {
                var h = this.getGlobalTaskIndex(_.id), g = this._pull[this._order[h + 1]];
                if (g) {
                    if (g.id == d.id)return;
                    _ = g
                } else if (g = this._pull[this._order[h]], g.$level == d.$level && g.id != d.id)return void this.moveTask(d.id, -1, g.parent)
            }
            for (var h = this.getGlobalTaskIndex(_.id), c = this._pull[this._order[h - 1]], u = 1; (!c || c.id == _.id) && h - u >= 0;)c = this._pull[this._order[h - u]], u++;
            if (d.id == _.id)return;
    ...
    var t = gantt._original_columns, e = gantt.config.columns;
    ...
    var t = new dhtmlxDnD(this.$grid_scale, {updates_per_second: 60});
    dhtmlx.defined(this.config.dnd_sensitivity) && (t.config.sensitivity = this.config.dnd_sensitivity), t.attachEvent("onBeforeDragStart", dhtmlx.bind(function (t, e) {
        ...
        if (!n)return!1;
        var i = this.locate(e, this.config.grid_resizer_column_attribute), a = this.getGridColumns()[i];
        ...
        var e = t.config, n = this.getGridColumns(), i = this._get_position(this.$grid_scale), a = parseInt(e.marker.style.left, 10), s = this.config.min_grid_column_width, r = this.$grid_data.offsetWidth - this.config.min_grid_column_width * (n.length - e.drag_index - 2), o = 0, d = 0;
        a -= i.x - 1;
        ...
        if (gantt.callEvent("onColumnResizeEnd", [i, a, r]) !== !1 && a.width != r) {
            if (a.width = r, gantt._original_columns[i].width = r, this.config.keep_grid_width)for (var s = i + 1, o = e.length; o > s; s++)e[s].width = "add" == e[s].name ? this._original_columns[s].width || 44 : null; else {
    ...
    var e = new dhtmlxDnD(this.$grid, {updates_per_second: 60});
    dhtmlx.defined(this.config.dnd_sensitivity) && (e.config.sensitivity = this.config.dnd_sensitivity), e.attachEvent("onBeforeDragStart", dhtmlx.bind(function (t, e) {
        ...
        var t = e.config, n = this.config.columns, i = this._get_position(this.$grid), a = parseInt(t.marker.style.left, 10), s = this.config.min_grid_column_width * n.length;
    ...
    if (gantt.config.branch_loading && gantt._load_url) {
        ...
        if (!e) {
            ...
            var i = n.indexOf("?") >= 0 ? "&" : "?";
            gantt.load(n + i + "parent_id=" + encodeURIComponent(t)), gantt.setUserData(t, "was_rendered", !0)
        }
    }
}), gantt.getGridColumns = function () {
    ...
    if (2 != t.button) {
        ...
        if (gantt.isTaskExists(n) && (i = gantt.getTask(n)), !gantt._is_readonly(i) && !this.drag.mode) {
            ...
            } else this.clear_drag_state(); else if (gantt.checkEvent("onMouseDown") && gantt.callEvent("onMouseDown", [a.split(" ")[0]]) && e.parentNode)return this.on_mouse_down(t, e.parentNode)
        }
    }
    ...
    gantt.config.work_time && gantt.config.correct_work_time && (e.mode == gantt.config.drag_mode.resize ? e.left ? t.start_date = gantt.getClosestWorkTime({date: t.start_date, dir: "future"}) : t.end_date = gantt.getClosestWorkTime({date: t.end_date, dir: "past"}) : e.mode == gantt.config.drag_mode.move && (gantt.isWorkTime(t.start_date) ? gantt.isWorkTime(new Date(+t.end_date - 1)) || (t.end_date = gantt.calculateEndDate(t.start_date, t.duration)) : (t.start_date = gantt.getClosestWorkTime({date: t.start_date, dir: "future"}), t.end_date = gantt.calculateEndDate(t.start_date, t.duration))))
    ...
    var e = this._path_builder.get_points(t), n = gantt._drawer, i = n.get_lines(e), a = document.createElement("div"), s = "gantt_task_link";
    ...
    var l = i[i.length - 1].direction, _ = gantt._render_link_arrow(e[e.length - 1], l);
    ...
    else if (t.type == gantt.config.links.finish_to_start)if (o = e.e_x > e.x + 2 * r, this.point_to(s.right, r), o)a -= r, this.point_to(s.down, i), this.point_to(s.right, a); else {
        a -= 2 * r;
        var d = i > 0 ? 1 : -1;
    ...
    function s(t, e, n, a) {
        ...
        if (h = Math.max(0, h - 3)) {
            s.className = _.join(" ");
            var g = (a - e) / (n - t), c = Math.atan(g);
            2 == o(t, n, e, a) ? c += Math.PI : 3 == o(t, n, e, a) && (c -= Math.PI);
            var u = Math.sin(c), f = Math.cos(c), p = Math.round(e), m = Math.round(t), v = ["-webkit-transform: rotate(" + c + "rad)", "-moz-transform: rotate(" + c + "rad)", "-ms-transform: rotate(" + c + "rad)", "-o-transform: rotate(" + c + "rad)", "transform: rotate(" + c + "rad)", "width:" + Math.round(h) + "px"];
    ...
    var _ = new dhtmlxDnD(this.$task_bars, {sensitivity: 0, updates_per_second: 60}), h = "task_left", g = "task_right", c = "gantt_link_point", u = "gantt_link_control";
    _.attachEvent("onBeforeDragStart", dhtmlx.bind(function (e, n) {
        ...
        n(r.marker, o);
        var d = gantt._is_link_drop_area(a), l = gantt._link_target_task, h = gantt._link_landing, c = gantt._link_target_task_start, f = gantt.locate(a), p = !0;
        ...
        if (t.from && t.to && t.from != t.to) {
            var e = gantt._get_link_type(t.from_start, t.to_start), t = {source: t.from, target: t.to, type: e};
    ...
    this._tasks = {col_width: this.config.columnWidth, width: [], full_width: 0, trace_x: [], rendered: {}}, this._click.gantt_task_link = dhtmlx.bind(function (t) {
        ...
        var e = gantt._get_mouse_pos(t), n = gantt._date_from_pos(e.x), i = Math.floor(gantt._day_index_by_date(n)), a = gantt._tasks.trace_x[i];
    ...
    var e = this._create_filter("_filter_task", "_is_grid_visible"), n = this._create_filter("_filter_task", "_is_chart_visible"), i = this._create_filter("_filter_link", "_is_chart_visible"), a = this._create_filter("_filter_task", "_is_chart_visible", "_is_std_background");
    ...
    for (var e = this.$task_data.childNodes, n = 0, i = e.length; i > n; n++)e[n].style && (e[n].style.width = t.full_width + "px");
    if (this._is_grid_visible()) {
        for (var a = this.getGridColumns(), s = 0, n = 0; n < a.length; n++)s += a[n].width;
        this.$grid_data.style.width = Math.max(s - 1, 0) + "px"
    }
    ...
    if (this._is_chart_visible()) {
        ...
        for (var r = this._get_resize_options(), o = r.x ? 0 : this.$task.offsetWidth, d = a.prepareConfigs(s, this.config.min_column_width, o, i), l = this._tasks = d[d.length - 1], _ = [], h = this.templates.scale_row_class, g = 0; g < d.length; g++) {
            var c = "gantt_scale_line", u = h(d[g]);
    ...
    var e = gantt._tasks, n = e.count, i = document.createElement("div");
    ...
    var d = t.$index % 2 !== 0, l = gantt.templates.task_row_class(t.start_date, t.end_date, t), _ = "gantt_task_row" + (d ? " odd" : "") + (l ? " " + l : "");
    ...
    var i = this.posFromDate(e || t.start_date), a = this.posFromDate(n || t.end_date);
    a = Math.max(i, a);
    var s = this.getTaskTop(t.id), r = this.config.task_height;
    return{left: i, top: s, height: r, width: Math.max(a - i, 0)}
    ...
    var e = this.config.type_renderers, n = e[this._get_safe_type(t.type)];
    ...
    var a = e.width[n] || e.col_width, s = 0;
    a && (s = (t - i) / a);
    var r = gantt._get_coll_duration(e, e.trace_x[n]), o = new Date(e.trace_x[n].valueOf() + Math.round(s * r));
    return o
    ...
    var e = new Date(t).valueOf(), n = gantt._tasks.trace_x, i = gantt._tasks.ignore_x;
    ...
    e = e !== !1, n = n || 0;
    var i = this._get_safe_type(t.type) == this.config.types.milestone, a = null;
    ...
    var t = gantt._tasks, e = gantt.$task_bg, n = document.createElement("canvas"), i = gantt.config.row_height, a = t.col_width;
    if (n.getContext) {
        n.height = i, n.width = a;
        var s = document.createElement("div"), r = document.createElement("div");
    ...
    if (t && this._task_layers.push(t), this.$task_data)for (var e = 0; e < this._task_layers.length; e++) {
        var t = this._task_layers[e], n = t.container, i = t.id, a = t.topmost;
    ...
    this._order = [], this._sync_order_item({parent: this.config.root_id, $open: !0, $ignore: !0, id: this.config.root_id}), t || (this._scroll_resize(), this._set_sizes())
    ...
    var n = e && e != this.config.root_id ? this.getTask(e) : !1, i = "";
    ...
    this._pull = {}, this._branches = {}, this._order = [], this._order_full = [], this._lpull = {}, this._update_flags(), this.refreshData(), this.userdata = {}, this.callEvent("onClear", [])
    ...
    if (t) {
        ...
        if (n.$no_start) {
            var i = 1 / 0;
            this.eachTask(function (t) {
                t.start_date && +t.start_date < +i && (i = new Date(t.start_date))
            }, n.id), n.start_date = 1 / 0 != i ? i : this._default_task_date(n, n.parent)
        }
        if (n.$no_end) {
            var a = 0;
            this.eachTask(function (t) {
                t.end_date && +t.end_date > +a && (a = new Date(t.end_date))
            }, n.id), n.end_date = a ? a : this.calculateEndDate(n.start_date, this.config.duration_step)
        }
    ...
    t.setTransactionMode("POST", !0), t.serverProcessor += (-1 != t.serverProcessor.indexOf("?") ? "&" : "?") + "editing=true", t._serverProcessor = t.serverProcessor, t.styles = {updated: "gantt_updated", inserted: "gantt_inserted", deleted: "gantt_deleted", invalid: "gantt_invalid", error: "gantt_error", clear: ""}, t._methods = ["_row_style", "setCellTextStyle", "_change_id", "_delete_task"], t.setGanttMode = function (e) {
        var n = t.modes || {};
        t._ganttMode && (n[t._ganttMode] = {_in_progress: t._in_progress, _invalid: t._invalid, updatedRows: t.updatedRows});
        var i = n[e];
        i || (i = n[e] = {_in_progress: {}, _invalid: {}, updatedRows: []}), t._in_progress = i._in_progress, t._invalid = i._invalid, t.updatedRows = i.updatedRows, t.modes = n, t._ganttMode = e
    ...
    t.afterUpdate = function (n, i, a, s, r) {
        ...
        var n;
        n = "tasks" == t._ganttMode ? this.isTaskExists(e) ? this.getTask(e) : {id: e} : this.isLinkExists(e) ? this.getLink(e) : {id: e}, n = dhtmlx.copy(n);
        var i = {};
    ...
    gantt.lightbox_events = {}, gantt.lightbox_events.gantt_save_btn = function () {
        ...
        if (e.getAttribute("dhx_button"))gantt.callEvent("onLightboxButton", [e.className, e, t]); else {
            var n, i, a;
            -1 != e.className.indexOf("gantt_custom_button") && (-1 != e.className.indexOf("gantt_custom_button_") ? (n = e.parentNode.getAttribute("index"), a = e.parentNode.parentNode) : (n = e.getAttribute("index"), a = e.parentNode, e = e.firstChild));
...
//    return n[t.type] && ("auto" == t.map_to ? e = {start_date: "start_date", end_date: "end_date", duration: "duration"} : "string" == typeof t.map_to && (e = {start_date: t.map_to})), e
    ...
    for (var e = this._get_typed_lightbox_config(), n = 0; n < e.length; n++) {
        ...
        i = i ? i.nextSibling : i;
        var a = this.form_blocks[e[n].type], s = a.get_value.call(this, i, t, e[n]), r = gantt._resolve_default_mapping(e[n]);
    ...
    for (var a = this._get_typed_lightbox_config(this.getLightboxType()), s = 0; s < a.length; s++) {
        ...
        if (this.form_blocks[r.type]) {
            var o = document.getElementById(r.id).nextSibling, d = this.form_blocks[r.type], l = gantt._resolve_default_mapping(a[s]), _ = dhtmlx.defined(n[l]) ? n[l] : r.default_value;
    ...
    var e = this.form_blocks.getTimePicker.call(this, t), n = ["<div style='height:30px;padding-top:0px;font-size:inherit;text-align:center;' class='gantt_section_time'>"];
    ...
    {
        var a = i, s = t.getElementsByTagName("select"), r = i._time_format_order;
        i._time_format_size
    }
    ...
    var _ = n[l.start_date] || new Date, h = n[l.end_date] || gantt.calculateEndDate(_, 1);
    ...
    var _ = gantt._resolve_default_mapping(n), h = {start_date: new Date(d), end_date: new Date(l)};
    ...
    var r = i, o = t.getElementsByTagName("select"), d = t.getElementsByTagName("input"), l = d[1], _ = [d[0], d[2]], h = t.getElementsByTagName("span")[0], g = i._time_format_order;
    ...
    var i = gantt.form_blocks.duration._get_start_date(t, n), a = gantt.form_blocks.duration._get_duration(t, n), s = gantt.calculateEndDate(i, a), r = gantt._resolve_default_mapping(n), o = {start_date: new Date(i), end_date: new Date(s), duration: a};
    ...
    var e = t, n = {render: e.render, focus: e.focus, set_value: function (t, i, a, s) {
        ...
        return i.disabled ? {start_date: null} : e.get_value.call(gantt, t, n, i)
        ...
        if (gantt.callEvent("onSectionToggle", [gantt._lightbox_id, e]), t.style.display = e.disabled ? "none" : "block", e.button) {
            var n = t.previousSibling.firstChild.firstChild, i = gantt.locale.labels, a = e.disabled ? i[e.name + "_enable_button"] : i[e.name + "_disable_button"];
        ...
        if (gantt.callEvent("onSectionButton", [gantt._lightbox_id, i]) !== !1) {
            var s = gantt.config.lightbox.sections[t];
            s.disabled ? n.enable(a, s) : n.disable(a, s)
        }
    }};
    return n
},gantt.form_blocks.duration_optional = gantt._extend_to_optional(gantt.form_blocks.duration),gantt.form_blocks.time_optional = gantt._extend_to_optional(gantt.form_blocks.time),dataProcessor.prototype = {setTransactionMode: function (t, e) {
...
},gantt.form_blocks.typeselect = {render: function (t) {
    var e = gantt.config.types, n = gantt.locale.labels, i = [], a = t.filter || function () {
        return!0
    };
    for (var s in e)!a(s, e[s]) == !1 && i.push({key: e[s], label: n["type_" + s]});
    t.options = i;
    var r = t.onchange;
    ...
    this._reinit(t), dhtmlxEvent(window, "resize", this._on_resize), this.init = function (t) {
    ...
    var a = {horPaddings: n.paddingLeft + n.paddingRight + n.borderLeftWidth + n.borderRightWidth, vertPaddings: n.paddingTop + n.paddingBottom + n.borderTopWidth + n.borderBottomWidth, borderBox: n.boxSizing, innerWidth: n.width, innerHeight: n.height, outerWidth: n.width, outerHeight: n.height};
    ...
    if (this._render_grid(), this._render_tasks_scales(), this._scroll_resize(), this._on_resize(), this._render_data(), this.config.preserve_scroll && t) {
        var e = gantt._restore_scroll_state(), n = gantt._date_from_pos(t.x);
        if (e.x != t.x || e.y != t.y) {
            if (n) {
    ...
    function t(t) {
        var n = gantt._get_resize_options(), i = e ? -20 * t.deltaX : t.wheelDeltaX, a = e ? -40 * t.deltaY : t.wheelDelta;
        if (i) {
            if (n.x)return!0;
            var s = i / -40, r = gantt.$task.scrollLeft + 30 * s;
    ...
    if (!(this._x < 20 || this._y < 20)) {
        var t = this._get_grid_width(), e = Math.max(this._x - t, 0), n = Math.max(this._y - this.config.scale_height, 0), i = this.config.scroll_size + 1, a = Math.max(this.$task_data.offsetWidth - i, 0), s = this.config.row_height * this._order.length, r = this._get_resize_options(), o = this._scroll_hor = r.x ? !1 : a > e, d = this._scroll_ver = r.y ? !1 : s > n;
    ...
    dhtmlx.mixin(gantt.config, {links: {finish_to_start: "0", start_to_start: "1", finish_to_finish: "2", start_to_finish: "3"}, types: {task: "task", project: "project", milestone: "milestone"}, duration_unit: "day", work_time: !1, correct_work_time: !1, skip_off_time: !1, autosize: !1, show_links: !0, show_task_cells: !0, static_background: !1, branch_loading: !1, show_loading: !1, show_chart: !0, show_grid: !0, min_duration: 36e5, xml_date: "%d-%m-%Y %H:%i", api_date: "%d-%m-%Y %H:%i", start_on_monday: !0, server_utc: !1, show_progress: !0, fit_tasks: !1, select_task: !0, preserve_scroll: !0, readonly: !1, date_grid: "%Y-%m-%d", drag_links: !0, drag_progress: !0, drag_resize: !0, drag_move: !0, drag_mode: {resize: "resize", progress: "progress", move: "move", ignore: "ignore"}, round_dnd_dates: !0, link_wrapper_width: 20, root_id: 0, autofit: !0, columns: [
        {name: "text", tree: !0, width: "*", resize: !0},
        {name: "start_date", align: "center", resize: !0},
        {name: "duration", align: "center"},
        {name: "add", width: "44"}
    ], step: 1, scale_unit: "day", subscales: [], time_step: 60, duration_step: 1, date_scale: "%d %M", task_date: "%d %F %Y", time_picker: "%H:%i", task_attribute: "task_id", link_attribute: "link_id", buttons_left: ["gantt_save_btn", "gantt_cancel_btn"], _migrate_buttons: {dhx_save_btn: "gantt_save_btn", dhx_cancel_btn: "gantt_cancel_btn", dhx_delete_btn: "gantt_delete_btn"}, buttons_right: ["gantt_delete_btn"], lightbox: {sections: [
    ...
    ]}, drag_lightbox: !0, sort: !1, details_on_create: !0, details_on_dblclick: !0, initial_scroll: !0, task_scroll_offset: 100, task_height: "full", min_column_width: 70, min_grid_column_width: 70, grid_resizer_column_attribute: "column_index", grid_resizer_attribute: "grid_resizer", keep_grid_width: !1, grid_resize: !1, readonly_property: "readonly", editable_property: "editable", type_renderers: {}, open_tree_initially: !1}), gantt.keys = {edit_save: 13, edit_cancel: 27}, gantt._init_template = function (t, e) {
