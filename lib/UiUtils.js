...
(function (UiUtils) {
    ...
    KGroupKeyIdentifiers[CbUtils.TGroupType.ByUser] = function (aAllMaps, aItem) {
    ...
    KGroupKeyIdentifiers[CbUtils.TGroupType.ByProject] = function (aAllMaps, aItem) {
        var task = aItem;
    ...
    KGroupKeyIdentifiers[CbUtils.TGroupType.BySprint] = function (aAllMaps, aItem) {
        var ret = KUnknownIdentifier;
    ...
    KGroupConverters[CbUtils.TGroupType.ByUser] = function (aAllMaps, aUri, aLoggingPadding, aParentId) {
    ...
    KGroupConverters[CbUtils.TGroupType.ByProject] = function (aAllMaps, aUri, aLoggingPadding, aParentId) {
    ...
    KGroupConverters[CbUtils.TGroupType.BySprint] = function (aAllMaps, aUri, aLoggingPadding, aParentId) {
    ...
    (function (FilterHelper) {
        ...
        function getFilterType(aFilters) {
            ...
            var filters = CbUtils.TFilterType.None;
    ...
    var CCbGantt = (function (_super) {
        ...
        function CCbGantt(aEl, aReadOnly) {
            ...
            this.onLinkAdd = function (id, item) {
                console.log(id, item);
                CbUtils.cache.createAssociation(item.target, item.source, function (err, data) {
                    console.log('createAssocResp', err, data);
                });
            };
            this.onLinkUpdate = function (id, item) {
                console.log(id, item);
                CbUtils.cache.updateAssociation(item, function (err, data) {
                    console.log('updateAssocResp', err, data);
                });
            };
            this.onLinkDelete = function (id, item) {
                console.log(id, item);
                CbUtils.cache.deleteAssociation(id, function (err, data) {
