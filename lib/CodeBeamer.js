...
(function (CbUtils) {
    ...
    (function (UiUtils) {
        ...
        function generatePropertySorter(aProp, aAscending, aCompare, aAlternative) {
        ...
        var KSorterByType = {};
        KSorterByType[1 /* ByStartTime */] = generatePropertySorter('startDate', true, dateStringCompare, 'submittedAt');
        KSorterByType[2 /* ByStartTimeDsc */] = generatePropertySorter('startDate', false, dateStringCompare, 'submittedAt');
        ...
        function getDhxDataByProject(aProjectUri, aGroupings, aFilter, aSorting, aCb) {
            ...
            s.push(function (done) {
                ...
                var cbTasks = cachedProjectInfo.releases.splice(0);
