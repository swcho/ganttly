...
(function (CbUtils) {
    ...
    function getTasksByTrackers(aPrefix, aTrackers, aCb) {
    ...
    var CCbCache = (function () {
        ...
        CCbCache.prototype.createTaskByUser = function (aUserUri, aNewItem, aCb) {
            var _this = this;
            Cb.tracker.createItem(aNewItem, function (err, item) {
                if (item) {
                    _this._itemMap[item.uri] = item;
                    _this._cache[aUserUri].tasks.unshift(item);
                }
