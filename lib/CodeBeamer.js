...
(function (Cb) {
    ...
    var CAssociationApi = (function (_super) {
        ...
        CAssociationApi.prototype.createAssociation = function (aItem, aCb) {
            aItem.type = aItem.type || "/association/type/1";
            aItem.propagatingSuspects = aItem.propagatingSuspects || false;
            if (!aItem.description) {
                aItem.description = "Generated by ganttly";
                aItem.descFormat = "Wiki";
            }
            send('POST', '/association', aItem, aCb);
        };
        CAssociationApi.prototype.updateAssociation = function (aItem, aCb) {
            send('PUT', '/association', aItem, aCb);
        };
        CAssociationApi.prototype.deleteAssociation = function (aItemUri, aCb) {
...
(function (CbUtils) {
    ...
    var CCbCache = (function () {
        ...
        CCbCache.prototype.createAssociation = function (aFrom, aTo, aCb) {
            Cb.association.createAssociation({
                from: aFrom,
                to: aTo
            }, aCb);
        };
        CCbCache.prototype.updateAssociation = function (aItem, aCb) {
            Cb.association.updateAssociation(aItem, aCb);
        };
        CCbCache.prototype.deleteAssociation = function (aUri, aCb) {
            Cb.association.deleteAssociation(aUri, aCb);
        };
        return CCbCache;
    }());
    ...
    (function (TFilterType) {
        TFilterType[TFilterType["None"] = 0] = "None";
        TFilterType[TFilterType["ByWithoutCompletedTask"] = 1] = "ByWithoutCompletedTask";
        TFilterType[TFilterType["ByFromPast2Weeks"] = 2] = "ByFromPast2Weeks";
