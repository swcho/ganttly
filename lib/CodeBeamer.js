...
(function (CbUtils) {
    ...
    (function (UiUtils) {
        ...
        function generatePropertySorter(aPropOrder, aAscending, aCompare) {
        ...
        var KSorterByType = {};
        KSorterByType[1 /* ByStartTime */] = generatePropertySorter(['startDate'], true, dateStringCompare);
        KSorterByType[2 /* ByStartTimeDsc */] = generatePropertySorter(['startDate'], false, dateStringCompare);
        ...
        KSorterByType[5 /* BySubmittedTime */] = generatePropertySorter(['submittedDate'], true, dateStringCompare);
        KSorterByType[6 /* BySubmittedTimeDsc */] = generatePropertySorter(['submittedDate'], false, dateStringCompare);
        KSorterByType[7 /* ByModifiedTime */] = generatePropertySorter(['modifiedDate'], true, dateStringCompare);
        KSorterByType[8 /* ByModifiedTimeDsc */] = generatePropertySorter(['modifiedDate'], false, dateStringCompare);
