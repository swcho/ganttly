    ...
    (function (Gantt) {
        ...
        var CGantt = (function (_super) {
            ...
            CGantt.prototype._addTaskEvents = function () {
                ...
                this._addEvent('onAfterLinkAdd', function (id, item) {
                    if (_this.onLinkAdd) {
                        _this.onLinkAdd(id, item);
                    }
                });
                this._addEvent('onAfterLinkUpdate', function (id, item) {
                    if (_this.onLinkUpdate) {
                        _this.onLinkUpdate(id, item);
                    }
                });
                this._addEvent('onAfterLinkDelete', function (id, item) {
                    if (_this.onLinkDelete) {
                        _this.onLinkDelete(id, item);
                    }
                });
                /* Light box */
