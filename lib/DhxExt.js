    ...
    (function (Gantt) {
        ...
        var CGantt = (function (_super) {
            ...
            function CGantt(aEl, aReadOnly) {
                ...
                if (aReadOnly) {
                    this._addEventId(this._gantt.attachEvent("onTaskDblClick", function (id, event) {
                ...
                this._addEventId(this._gantt.attachEvent("onContextMenu", function (taskId, linkId, event) {
        ...
        Gantt.CGantt = CGantt;
    })(DhxExt.Gantt || (DhxExt.Gantt = {}));
    var Gantt = DhxExt.Gantt;
})(DhxExt || (DhxExt = {}));
